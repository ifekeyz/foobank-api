const signupTemp = function (name: string, otp: string) {
    const html = `
    <!DOCTYPE html>
  ...
  style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1;">
                ...
                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="font-weight: 600; font-size: 18px; margin-bottom: 10px;margin-top: 10px">Dear ${name} Your otp: ${otp},</p>

                      <p style="margin: 0 0 24px;">
                      We are delighted to welcome you to Mediplan! Thank you for signing up.
                      ...
                      <p style="margin: 0 0 24px;">
                      MediPlan is designed to help you manage and book appointments. Our team has worked hard to create a seamless user experience, and we hope you find our app easy to use and enjoyable.
                      </p>

                      <p style="margin: 0 0 24px;">
                      Once again, thank you for choosing MediPlan! We are excited to have you on board and look forward to seeing how you will use our app to book appointment.
                      </p>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:mediplan@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">mediplan@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
    ...
    const subject = `Welcome to MediPlan!`;
